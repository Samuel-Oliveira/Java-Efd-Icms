...
private final String reg = "C600";
	...
	/**
	 * @return the vl_cofinss
	 */
	public String getVl_cofinss() {
		return vl_cofinss;
	}
	/**
	 * @param vl_cofinss the vl_cofinss to set
	 */
	public void setVl_cofinss(String vl_cofinss) {
		this.vl_cofinss = vl_cofinss;
	}
	/**
	 * @return the reg
	 */
