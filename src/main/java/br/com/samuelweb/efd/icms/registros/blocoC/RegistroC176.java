...
public class RegistroC176 {
	...
	/**
	 * @param cod_part_ult_e
	 *            the cod_part_ult_e to set
	 */
	...
	/**
	 * @param chave_nfe_ult_e
	 *            the chave_nfe_ult_e to set
	 */
	...
	/**
	 * @param num_item_ult_e
	 *            the num_item_ult_e to set
	 */
	...
	/**
	 * @param vl_unit_bc_icms_ult_e
	 *            the vl_unit_bc_icms_ult_e to set
	 */
	...
	/**
	 * @param aliq_icms_ult_e
	 *            the aliq_icms_ult_e to set
	 */
	...
	/**
	 * @param vl_unit_limite_bc_icms_ult_e
	 *            the vl_unit_limite_bc_icms_ult_e to set
	 */
	...
	/**
	 * @param vl_unit_icms_ult_e
	 *            the vl_unit_icms_ult_e to set
	 */
	...
	/**
	 * @param cod_part_nfe_ret
	 *            the cod_part_nfe_ret to set
	 */
