...
public class RegistroE210 {
	...
	/**
	 * @param vl_sld_cred_ant_st
	 *            the vl_sld_cred_ant_st to set
	 */
	...
	/**
	 * @param vl_out_cred_st
	 *            the vl_out_cred_st to set
	 */
	...
	/**
	 * @param vl_aj_creditos_st
	 *            the vl_aj_creditos_st to set
	 */
	...
	/**
	 * @param vl_retencao_st
	 *            the vl_retencao_st to set
	 */
	...
	/**
	 * @param vl_aj_debitos_st
	 *            the vl_aj_debitos_st to set
	 */
	...
	/**
	 * @param vl_sld_dev_ant_st
	 *            the vl_sld_dev_ant_st to set
	 */
	...
	/**
	 * @param vl_deducoes_st
	 *            the vl_deducoes_st to set
	 */
	...
	/**
	 * @param vl_icms_recol_st
	 *            the vl_icms_recol_st to set
	 */
	...
	/**
	 * @param vl_sld_cred_st_transportar
	 *            the vl_sld_cred_st_transportar to set
	 */
