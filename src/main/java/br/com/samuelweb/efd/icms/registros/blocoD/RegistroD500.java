...
private final String reg = "D500";
	...
	/**
	 * @param cl_desc the cl_desc to set
	 */
	...
	/**
	 * @return the tp_assiante
	 */
	public String getTp_assiante() {
		return tp_assiante;
	}
	/**
	 * @param tp_assiante the tp_assiante to set
	 */
	public void setTp_assiante(String tp_assiante) {
		this.tp_assiante = tp_assiante;
	}
	/**
	 * @return the reg
	 */
