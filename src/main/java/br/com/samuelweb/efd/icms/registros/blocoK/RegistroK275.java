...
private final String reg = "K275";
	...
	/**
	 * @return the ncod_ins_subst
	 */
	public String getNcod_ins_subst() {
		return ncod_ins_subst;
	}
	/**
	 * @param ncod_ins_subst the ncod_ins_subst to set
	 */
	public void setNcod_ins_subst(String ncod_ins_subst) {
		this.ncod_ins_subst = ncod_ins_subst;
	}
	/**
	 * @return the reg
	 */
