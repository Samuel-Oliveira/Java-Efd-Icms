...
public class RegistroD140 {
	...
	/**
	 * @param cod_part_consg
	 *            the cod_part_consg to set
	 */
	...
	/**
	 * @param vl_desp_car_desc
	 *            the vl_desp_car_desc to set
	 */
