...
public class RegistroE310 {
	...
	/**
	 * @param ind_mov_fcp_difal
	 *            the ind_mov_fcp_difal to set
	 */
	...
	/**
	 * @param vl_sld_cred_ant_difal
	 *            the vl_sld_cred_ant_difal to set
	 */
	...
	/**
	 * @param vl_tot_debitos_difal
	 *            the vl_tot_debitos_difal to set
	 */
	...
	/**
	 * @param vl_out_deb_difal
	 *            the vl_out_deb_difal to set
	 */
	...
	/**
	 * @param vl_tot_creditos_difal
	 *            the vl_tot_creditos_difal to set
	 */
	...
	/**
	 * @param vl_out_cred_difal
	 *            the vl_out_cred_difal to set
	 */
	...
	/**
	 * @param vl_sld_dev_ant_difal
	 *            the vl_sld_dev_ant_difal to set
	 */
	...
	/**
	 * @param vl_deducoes_difal
	 *            the vl_deducoes_difal to set
	 */
	...
	/**
	 * @param vl_recol_difal
	 *            the vl_recol_difal to set
	 */
	...
	/**
	 * @param vl_sld_cred_transportar_difal
	 *            the vl_sld_cred_transportar_difal to set
	 */
	...
	/**
	 * @param vl_sld_cred_ant_fcp
	 *            the vl_sld_cred_ant_fcp to set
	 */
	...
	/**
	 * @param vl_tot_deb_fcp
	 *            the vl_tot_deb_fcp to set
	 */
	...
	/**
	 * @param vl_out_deb_fcp
	 *            the vl_out_deb_fcp to set
	 */
	...
	/**
	 * @param vl_tot_cred_fcp
	 *            the vl_tot_cred_fcp to set
	 */
	...
	/**
	 * @param vl_out_cred_fcp
	 *            the vl_out_cred_fcp to set
	 */
	...
	/**
	 * @param vl_sld_dev_ant_fcp
	 *            the vl_sld_dev_ant_fcp to set
	 */
	...
	/**
	 * @param vl_deducoes_fcp
	 *            the vl_deducoes_fcp to set
	 */
	...
	/**
	 * @param vl_sld_cred_transportar_fcp
	 *            the vl_sld_cred_transportar_fcp to set
	 */
