...
public class Registro1920 {
	...
	private String vl_tot_tranf_creditos_oa;
	...
	/**
	 * @return the vl_tot_tranf_creditos_oa
	 */
	public String getVl_tot_tranf_creditos_oa() {
		return vl_tot_tranf_creditos_oa;
	}
	/**
	 * @param vl_tot_tranf_creditos_oa the vl_tot_tranf_creditos_oa to set
	 */
	public void setVl_tot_tranf_creditos_oa(String vl_tot_tranf_creditos_oa) {
		this.vl_tot_tranf_creditos_oa = vl_tot_tranf_creditos_oa;
	}
	/**
