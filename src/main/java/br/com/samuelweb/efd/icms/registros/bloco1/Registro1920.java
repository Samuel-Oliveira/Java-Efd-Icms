...
public class Registro1920 {
	...
	/**
	 * @param vl_tot_transf_debitos_oa
	 *            the vl_tot_transf_debitos_oa to set
	 */
	...
	/**
	 * @param vl_tot_aj_debitos_oa
	 *            the vl_tot_aj_debitos_oa to set
	 */
	...
	/**
	 * @param vl_estornos_cred_oa
	 *            the vl_estornos_cred_oa to set
	 */
	...
	/**
	 * @param vl_tot_transf_creditos_oa
	 *            the vl_tot_transf_creditos_oa to set
	 */
	...
	/**
	 * @param vl_tot_aj_creditos_oa
	 *            the vl_tot_aj_creditos_oa to set
	 */
	...
	/**
	 * @param vl_estornos_deb_oa
	 *            the vl_estornos_deb_oa to set
	 */
	...
	/**
	 * @param vl_sld_credor_ant_oa
	 *            the vl_sld_credor_ant_oa to set
	 */
	...
	/**
	 * @param vl_sld_apurado_oa
	 *            the vl_sld_apurado_oa to set
	 */
	...
	/**
	 * @param vl_icms_recolher_oa
	 *            the vl_icms_recolher_oa to set
	 */
	...
	/**
	 * @param vl_sld_credor_transp_oa
	 *            the vl_sld_credor_transp_oa to set
	 */
